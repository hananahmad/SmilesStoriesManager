...
enum StoriesRequestBuilder {
    ...
    func createRequest(baseURL: String, endPoint: StoriesEndPoints) -> NetworkRequest {
        var headers: Headers = [:]
    ...
    func getURL(from baseURL: String, for endPoint: StoriesEndPoints) -> String {
